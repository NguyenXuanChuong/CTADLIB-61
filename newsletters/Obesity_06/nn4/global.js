...
//-------------------------------------------------------------------------------
   ...
   var gsFName =        "Overweight";			// file name 
   var gsFullName =	   "Overweight";			// full-file name
   ...
   var gsTitle = "obesenewsletter";					// Title of File 

   var gCSSPath = "./Overweight/nn4/";
   var gNN4Path = "./Overweight/nn4/";
//-------------------------------------------------------------------------------
// navigation options:
//-------------------------------------------------------------------------------

   var gNavigation =    0; 				// 0=None 1=Top 2=Left 3=Bookmark Left 
   var gsHomeURL =      "";			// link for HOME icon  
   var gsOriginalLink = "";			// link for DOWNLOAD icon 
   var gsCustomText =   "";			// Custom Link Text 
   var gsCustomLink =   "";			// link for Custom Link Text 
...
// note: 1=enable; 0=disable 
   var gShowToolbar = 1; 			// show or hide Toolbar 
...
//-------------------------------------------------------------------------------
   ...
   // browser detection  
   //------------------------------------------------------------------------------- 
   var gBrowser = 0;				// note: DO NOT change these settings  
   var IE = 1; 
   var NN = 2; 
   var MO = 3; 
   var OP = 4; 
