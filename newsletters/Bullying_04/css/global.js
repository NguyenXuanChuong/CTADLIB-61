...
//-------------------------------------------------------------------------------
   ...
   var gsFName =        "Bullying";			// file name 
   var gsFullName =     "Bullying";			// full file name 
   ...
   var gsTitle = "Bullying";					// Title of File 

   var gCSSPath = "./Bullying/css/";
   var gNN4Path = "./Bullying/css/";
//-------------------------------------------------------------------------------
// navigation options:
//-------------------------------------------------------------------------------
   ...
   var gsCustomLink =   "www.comprehensivenet.com\bullying.html";			// link for Custom Link Text 
